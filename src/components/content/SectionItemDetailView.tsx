        ...
        <div className="pt-8 grid grid-cols-1 gap-8 lg:grid-cols-[1fr_300px]">
          <main className="space-y-6">
            <section className="site-panel p-6">
              <div className="flex flex-col items-start gap-6 lg:flex-row lg:items-start lg:justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  {item.pdfUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="mt-4 inline-flex items-center gap-2 rounded-full bg-[#0f766e] px-4 py-2 text-xs font-semibold text-white"
                    >
                      <FileText size={14} />
                      View PDF
                    </a>
                ...
                {(item.author?.trim() || item.publishedDate?.trim()) && (
                  <div className="w-full shrink-0 rounded-2xl border border-[#cdd8df] bg-[#f3f7fb] px-4 py-4 text-xs text-[#556678] shadow-sm sm:w-auto sm:min-w-[200px]">
                    {item.author?.trim() && (
            ...
            <section className="site-panel p-6">
              ...
              <div
                className="content-body mt-4 space-y-4 text-sm leading-relaxed text-[#415261] [&_p]:mb-4 [&_p:last-child]:mb-0 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_strong]:font-semibold [&_strong]:text-[#17324a]"
