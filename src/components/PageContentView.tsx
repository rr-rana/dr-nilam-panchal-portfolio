        ...
        <div className="pt-8 grid grid-cols-1 gap-8 lg:grid-cols-[280px_1fr]">
          ...
          <main className="space-y-8">
            <section className="site-panel p-6">
              <div
                className="content-body space-y-4 text-sm leading-relaxed text-[#3f4f60] [&_p]:mb-4 [&_p:last-child]:mb-0 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_strong]:font-semibold [&_strong]:text-[#1f3248]"
